...
func (t *serverConnectUDP) String() string {
	return fmt.Sprintf("udp {connectId: %d, ccName: %s, ccAddr: %s, csName: %s csAddr: %s, targetAddr: %s status: %s}", t.connectId, t.ccName, t.ccAddr, t.csName, t.csAddr, t.targetAddr, t.status)
}
