...
func (t *serverHandle) serverProxyNewConnectRequest(ccTCP *io.TCP, proxyNewConnectRequest *msg.ProxyNewConnectRequest) {
...
func (t *serverHandle) addConnectTCP(connectId utils.ID, proxy *msg.ProxyNewConnectRequest) *serverConnectTCP {
...
func (t *serverHandle) serverProxyNewConnectResponseTCP(_ *io.TCP, proxyNewConnectResponse *msg.ProxyNewConnectResponse) {
...
func (t *serverHandle) tcpBind(csTCP *io.TCP, proxyNewConnectResponse *msg.ProxyNewConnectResponse) {
	ccTCPConnect, ok := t.connectTCP[proxyNewConnectResponse.ServerId]
	if !ok {
		log.Error("no find ccTCP by", proxyNewConnectResponse.ServerId)
		return
