...
func (t *clientHandle) newConnectTCP(serviceName string, localConn *net.TCPConn, clientConfig *clientConfigTCP) {
	...
	// 初始化
	if e := remoteTCP.ClientInit(msg.ClientTypeP2p); e != nil {
...
func (t *clientHandle) p2pNewConnectRequestTCP(serverTCP *io.TCP, proxyNewConnectRequest *msg.P2pNewConnectRequest) {
